...
import com.mada.test.bio.adapter.ContactsAdapter;
import com.mada.test.bio.db.ContactsAppDatabase;
import com.mada.test.bio.db.entity.Contact;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void addAndEditContacts(final boolean isUpdate, final Contact contact, final int position) {
        ...
        final EditText contactAddress = view.findViewById(R.id.address);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isUpdate && contact != null) {
                    ...
                    updateContact(newContact.getText().toString(), contactEmail.getText().toString(), contactPhone.getText().toString(), contactAddress.getText().toString(), position);
                } else {

                    createContact(newContact.getText().toString(), contactEmail.getText().toString(), contactPhone.getText().toString(), contactAddress.getText().toString());
                }
            }
        });
    }
    ...
    private void updateContact(String name, String email, String phone, String address, int position) {
    ...
    private void createContact(String name, String email, String phone, String address) {

      new CreateContactAsyncTask().execute(new Contact(0,name,email,phone,address));
 ...
 RoomDatabase.Callback callback= new RoomDatabase.Callback() {
     ...
     public void onCreate(@NonNull SupportSQLiteDatabase db) {
         ...
         createContact("name 1","email 1", "phone 1", "address 1");
